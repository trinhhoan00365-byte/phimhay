const AFF_LINK = "https://in.avboy66s.workers.dev"; // worker PRO
...
/* =========================
   OPEN AFF PRO (FIX SAFARI)
========================= */
function openAffPro() {
  // ưu tiên mở cùng tab (Safari + Shopee thích nhất)
  location.href = AFF_LINK;

  // fallback mở tab mới nếu Safari chặn
  setTimeout(() => {
